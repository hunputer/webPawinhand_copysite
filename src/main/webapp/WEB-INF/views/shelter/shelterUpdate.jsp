...
<c:import url="../template/header.jsp"></c:import>	
    ...
    <div class="shelWr-div">
      ...
      value="${updto.center}" id="center" name="center" readonly="readonly" style="background-color: white;">
    </div>
    
    <div class="shelWr-div">
	  <label for="보호센터 연락처" class="shelWr-label">연 락 처 </label>
      <input type="text" class="form-control shelWr-input" id="center_tel" name="center_tel" value="${updto.center_tel}"/>
    </div>
    ...
    <div class="shelWr-div">
      ...
      <input type="text" class="form-control shelWr-input" value="${updto.place_of_find}" id="place_of_find" name="place_of_find">
    </div>
    ...
    <div class="shelWr-div">
      ...
      <input type="date" class="form-control period shelWr-input" value="${updto.period_2}" id="period_2" name="period_2" onclick="validDate()">
    </div>
